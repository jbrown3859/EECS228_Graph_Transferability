...
def train(data, source_features_reduced, epochs, plot=False):
    ...
    for epoch in range(epochs):
            ...
            if (test_acc > best_test_acc):
                ...
                torch.save(model.state_dict(), "./train_model/airport_eu_best_GCN.pth")
...
if __name__ == "__main__":
    ...
    # dataset = Planetoid(root='./data', name='airports')
    dataset = airports.Airports(root="./data", name="Europe")
